...
"commands":{
  ...
  "COMMS & SOCIAL (DELIVERY)":{
    "/social":{"syntax":"/social <action> <platform> [target] <text>","desc":"Post to Discord/Telegram/X/Mastodon/Bluesky (NOT email) [DELIVERY]",
      ...
      "format_only_ex":["/social post discord <channel> <text>","/social discord read <channel>","/social discord dm <user> <text>","/social discord dm Babadoo and Nubster Check this out!","/social post discord general Check this out: responses/review.md","/social discord dm PageOfABook Here is the report: responses/scrape-report.md"],
