...
- **Total time** — ~5 minutes on Snapdragon 8 Elite with `qwen35-4b-think`
...
- **Model swap for debugging** — If your API has a subtle bug, temporarily `/models select primary qwen35-4b-think` for stronger reasoning, then switch back.
