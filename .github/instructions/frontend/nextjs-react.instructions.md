---
name: 'Next.js & React Standards'
description: 'Component architecture, App Router conventions, and state management'
applyTo: '{frontend,web,app,src,pages,components}/**/*.{tsx,ts,jsx,js}, **/app/**/*.{tsx,ts,jsx,js}, **/pages/**/*.{tsx,ts,jsx,js}'
---
