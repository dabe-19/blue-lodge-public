...
description: 'GitHub Actions, GitLab CI, Azure Pipelines, and CircleCI workflow standards'
applyTo: '.github/workflows/**/*.{yml,yaml}, .gitlab-ci.yml, **/azure-pipelines*.{yml,yaml}, .circleci/config.yml, **/Jenkinsfile, **/buildkite/**/*.{yml,yaml}'
---
