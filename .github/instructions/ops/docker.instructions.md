...
description: 'Best practices for Dockerfiles and Docker Compose orchestration'
applyTo: '**/*Dockerfile*, **/*.dockerfile, **/Containerfile, **/docker-compose*.{yml,yaml}, **/compose*.{yml,yaml}, **/.dockerignore'
---
