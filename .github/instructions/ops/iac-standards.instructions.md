...
description: 'Terraform, Pulumi, Bicep, CloudFormation, and Kubernetes manifest standards'
applyTo: '**/*.tf, **/*.tfvars, **/*.hcl, **/*.bicep, **/cloudformation/**/*.{yaml,yml,json}, **/k8s/**/*.{yaml,yml}, **/kubernetes/**/*.{yaml,yml}, **/manifests/**/*.{yaml,yml}, **/helm/**/*.{yaml,yml,tpl}'
---
