...
description: 'SQL style, schema migrations, and safe data-access patterns'
applyTo: '**/*.sql, **/migrations/**/*, **/*Repository*.{cs,ts,js,py,go,rs,java,kt}, **/*Dao*.{cs,ts,js,py,go,rs,java,kt}'
---
