...
description: 'Test structure, naming, isolation, and coverage discipline across languages'
applyTo: '**/*test*.{py,ts,tsx,js,jsx,go,rs,cs,java,kt,cpp,rb}, **/*spec*.{py,ts,tsx,js,jsx,go,rs,cs,java,kt,cpp,rb}, **/tests/**/*, **/__tests__/**/*, **/test/**/*'
---
# Testing Standards
